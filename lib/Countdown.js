...
var Countdown = function (_Component) {
    ...
    _createClass(Countdown, [{
        ...
        value: function tick() {
            ...
            var endDate = moment(this.props.options.endDate).unix();
            var remaining = (0, _DateBetween2.default)(startDate, endDate, this.props.options.endDate);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'date', dangerouslySetInnerHTML: { __html: this.state.remaining } }),
